  ...
  return (
    <section className='w-[90%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10'>
        <div className="p-14 flex flex-col gap-5 bg-text_color_dark dark:bg-card_color_dark rounded-xl">
          ...
          {/* Textarea */}
          <Textarea placeholder="Your Feedback" value={feedback} onChange={handleFeedbackChange} className='h-full'/>

          {/* Button */}
          <button onClick={handleSubmit} className="inline-block px-5 font-semibold bg-background_dark_mode py-2 rounded-tl-[20px] rounded-br-[20px] w-max">
