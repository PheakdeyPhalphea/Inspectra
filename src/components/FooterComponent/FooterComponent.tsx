  ...
  return (
    <footer className="w-[95%] md:w-[98%] rounded-lg bg-card_color_light dark:bg-card_color_dark h-full mx-auto">
      <div className="w-[95%] mx-auto">
        <section className="px-4 sm:px-6 grid grid-cols-1 md:grid-cols-4 sm:grid-cols-2 gap-6 mx-auto">
          {/* logo */}
          ...
          <div className="p-2 md:p-5">
            ...
            <div className="flex flex-col h-auto w-full mt-5 space-y-5 items-start">
              <img
